...
const starterQuestions = [
  ...
  "Tell me about Project Atlas's architecture",
  'Summarize the experience and technical skills',
];
  ...
  return (
    <>
      <button
        ...
        aria-label={`Ask ${siteConfig.name}'s portfolio assistant`}
        aria-expanded={isOpen}
      >
        <span className={styles.triggerIcon} aria-hidden="true">AI/</span>
        <span className={styles.triggerCopy}>
          <span>ASK PORTFOLIO_AI</span>
        ...
        {isOpen && (
          <>
            ...
            <motion.section
              ...
              role="dialog"
              aria-label={`${siteConfig.name}'s portfolio assistant`}
            ...
            >
              ...
              <div className={styles.transcript} aria-live="polite">
                <div className={`${styles.messageRow} ${styles.assistantRow}`}>
                  <span className={styles.messageLabel}>PORTFOLIO_AI / 00</span>
                  <div className={styles.messageBubble}>
                    I can answer questions about {siteConfig.name}&apos;s experience, education, projects, and technical skills. What would you like to explore?
                  </div>
                </div>
                  ...
                  return (
                    ...
                    >
                      <span className={styles.messageLabel}>
                        {isUser ? 'VISITOR' : 'PORTFOLIO_AI'} / {String(index + 1).padStart(2, '0')}
                      </span>
                ...
                {status === 'submitted' && (
                  <div className={`${styles.messageRow} ${styles.assistantRow}`}>
                    <span className={styles.messageLabel}>PORTFOLIO_AI / PROCESSING</span>
                    <div className={styles.loadingBars} aria-label="Portfolio assistant is thinking">
                      <i></i><i></i><i></i><i></i>
                    </div>
                  </div>
                )}
